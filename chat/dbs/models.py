...
class User(DeletedModel, ModelDictMixin):
    ...
    username = Column(String(length=255))  # 姓名
    avator = Column(String(length=255))  # 头像
    socket_id = Column(String(length=255))       # socket_id
    is_online = Column(Integer())        # 是否在线
